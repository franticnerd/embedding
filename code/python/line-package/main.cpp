...
line_hin hin_ww, hin_ll, hin_tt, hin_wl, hin_lt, hin_tw;
line_trainer_edge trainer_edge_ww, trainer_edge_ll, trainer_edge_tt, trainer_edge_wl, trainer_edge_lt, trainer_edge_tw;
...
void TrainModel() {
    ...
    node_w.output(output_file_w, binary);
    node_l.output(output_file_l, binary);
    node_t.output(output_file_t, binary);
}
